...
<TailFloatingActionMenu Style="background-color: #3b82f6; color: white;">
    Custom Styled
</TailFloatingActionMenu>

@* Using Class parameter *@
<TailFloatingActionMenu Class="my-custom-class shadow-lg">
    With Custom Class
</TailFloatingActionMenu>
```
...
<EditForm Model="@model" OnValidSubmit="HandleSubmit">
    ...
    <TailFloatingActionMenu Type="submit">
        Submit Form
    </TailFloatingActionMenu>
</EditForm>
...
- **Package ID**: `Tail.Blazor.FloatingActionMenu`
- **Version**: 1.0.0
- **License**: MIT
