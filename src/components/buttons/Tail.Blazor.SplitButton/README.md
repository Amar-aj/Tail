...
<TailSplitButton Disabled="@isDisabled" IsLoading="@isProcessing">
    @if (isProcessing)
    {
...
<TailSplitButton OnClick="ToggleProcessing">
    Toggle State
</TailSplitButton>
...
```razor
<TailSplitButton Tooltip="This is a helpful tooltip">
    Hover for Tooltip
</TailSplitButton>
```
...
```razor
<TailSplitButton 
    OnPrimaryClick="OnFirstEvent"
    OnDropdownToggle="OnSecondEvent">
    Multiple Events
</TailSplitButton>
...
<TailSplitButton Variant="Primary action button" Tooltip="Click to perform action">
    Accessible Button
</TailSplitButton>
```
...
- **Package ID**: `Tail.Blazor.SplitButton`
- **Version**: 1.0.0
- **License**: MIT
