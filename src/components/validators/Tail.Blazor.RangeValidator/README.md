...
<TailRangeValidator Style="background-color: #3b82f6; color: white;">
    Custom Styled
</TailRangeValidator>

@* Using Class parameter *@
<TailRangeValidator Class="my-custom-class shadow-lg">
    With Custom Class
</TailRangeValidator>
```
...
- **Package ID**: `Tail.Blazor.RangeValidator`
- **Version**: 1.0.0
- **License**: MIT
