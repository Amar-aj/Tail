...
<TailPanel Style="background-color: #3b82f6; color: white;">
    Custom Styled
</TailPanel>

@* Using Class parameter *@
<TailPanel Class="my-custom-class shadow-lg">
    With Custom Class
</TailPanel>
```
...
<TailPanel Variant="Primary action button">
    Accessible Button
</TailPanel>
```
